      ...
      <section className="bg-card section-padding">
        <div className="container-max max-w-4xl">
          <div className="prose prose-lg max-w-none space-y-8 text-muted-foreground">
            ...
            <div><h2 className="font-display text-2xl font-bold text-foreground">2. Services Description</h2><p>Liklet provides web development, digital marketing, social media marketing, and content creation services. The specific scope of services will be defined in individual project agreements.</p></div>
